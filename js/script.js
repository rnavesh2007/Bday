/* ==========================================================================
   BIRTHDAY SURPRISE â€” SCRIPT
   Vanilla JS. No build step. Everything self-contained.
   ========================================================================== */

/* --------------------------------------------------------------------------
   CONFIG â€” edit these to customize without touching the logic below
   -------------------------------------------------------------------------- */
const CONFIG = {
  ...
  // Media folders â€” files placed here are detected automatically (see below)
  PHOTO_FILENAMES: [],   // e.g. ["photo1.jpg", "photo2.jpg"] â€” leave empty to auto-try common names
...
/* --------------------------------------------------------------------------
   PAGE 2 â€” CAKE: countdown then candles
   -------------------------------------------------------------------------- */
(function cakePage() {
...
/* --------------------------------------------------------------------------
   CONFETTI (lightweight canvas-based, no external dependency required â€”
...
/* --------------------------------------------------------------------------
   PAGE 3 â€” CELEBRATION: balloons, fairy lights, hearts, periodic confetti
   -------------------------------------------------------------------------- */
...
(function letterPage() {
  ...
  $$('.typewriter-hidden.script.big')[0] && ($$('.typewriter-hidden.script.big')[0].textContent = CONFIG.YOUR_NAME + " â¤");
...
/* --------------------------------------------------------------------------
   PAGE 6 â€” MEMORIES GALLERY (auto-detect photos & videos)
   -------------------------------------------------------------------------- */
